...
class First_msg(fct):
	First_msgEN="Welcome to FlyRodCrosby, an auto-installer for standard secure communications tools.  Select the apps you want to install below and click OK to begin the installation process."
	First_msgFR="Bienvenue à FlyRodCrosby, un auto-installeur pour des outils standard de communications sécurisées. Selectionnez les applications que vous souhaitez installer ci-dessous et cliquez sur OK pour commencer le processus d'installation."
	First_msgES="Bienvenido a FlyRodCrosby, un instalador automático de herramientas de comunicación seguras estándar. Seleccione las aplicaciones que desea instalar a continuación y haga clic en Aceptar para comenzar el proceso de instalación."
	First_msgIT="Benvenuti a FlyRodCrosby, un auto-installer per gli strumenti di comunicazione sicuri standard. Selezionare le applicazioni che si desidera installare sotto e fare clic su OK per avviare il processo di installazione."
	...
	First_msgRU="Добро пожаловать в FlyRodCrosby, авто-установки для стандартных инструментов безопасных коммуникаций. Выберите приложения, которые требуется установить ниже и нажмите кнопку ОК, чтобы начать процесс установки."
